...
<div class="min-h-screen p-6">
    <header class="mb-6">
        ...
        <p class="text-gray-500 mt-1">Catat sampel/seeding ke affiliate TikTok & Shopee. Otomatis <b>masuk antrean racik</b> (pesanan harga 0) — stok bibit/komponen dipotong saat diracik. HPP masuk Biaya Promo di P&L.</p>
    </header>
                            ...
                            @forelse($riwayat as $r)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        <form method="POST" action="{{ route('sampel.destroy', $r->id) }}" onsubmit="return confirm('Hapus catatan ini & pesanan racik-nya? Bila sudah diracik, stok bibit/komponen dikembalikan.')">
                                            @csrf @method('DELETE')
